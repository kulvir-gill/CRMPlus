    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AccountNumber = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false, defaultValue: "0000"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimesheetEntries_WorkItems_WorkItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_PrimaryAddressId",
                table: "Accounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimesheetEntries_WorkItemId",
                table: "TimesheetEntries",
                column: "WorkItemId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Accounts_Addresses_PrimaryAddressId",
                table: "Accounts",
                column: "PrimaryAddressId",
